      ...
      <div className="sidediv">
        ...
        <div className='bg-white border rounded'>
          ...
          <form action="">
            ...
            <input type="text"  placeholder='' className='input' value={username} onChange={(e)=>setUserName(e.target.value)}/>
            ...
            <input type="number"  placeholder='' className='input' value={phoneNumber} onChange={(e)=>setPhoneNumber(e.target.value)}/>
